...
export function Login() {
    ...
    function handleInputChangeUsuario(event: React.ChangeEvent<HTMLInputElement>) {
        setInputUsuario(event.target.value);
    }

    function handleInputChangeSenha(event: React.ChangeEvent<HTMLInputElement>) {
        setInputSenha(event.target.value);
    }
    function handleSubmit() {
        if (inputUsuario === "admin" && inputSenha === "admin") {
          setSenhaCerta(true);
        } else {
    ...
    return (<div className="Fundo">
                <div className="dados">
                    ...
                    <button className="login" onClick={handleSubmit}>Entrar</button>
                </div>
                <div className="onda">
